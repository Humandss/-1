...
public class ShellManager : MonoBehaviour
{
    ...
    [SerializeField, Range(0f, 2f)] private float shellSfxVolume = 1.0f;
    ...
    public void PlayShellSound()
    {
        ...
        AudioClip clip = GetRandomAudioClip(shellSounds);
        if (clip == null) return;
        shellAudioSource.PlayOneShot(clip, shellSfxVolume);
        isPlayOnced=false;
    }
